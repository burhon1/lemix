...
urlpatterns = [
    ...
    # path('course/<int:id>/detail/',courses.course_detail_view,name='course-detail'),
    ...
    path('course/<int:pk>/detail/', courses.get_course_edit_view, name='course-detail-edit'),
    ...
    path('teacher/<int:id>/getdata/',teachers.get_teacher_edit_view,name='teacher-getdata'),
    ...
    path('groups/filter/',groups.groups_by_filter_view,name='groups-filter'),
    ...
    path('group/<int:id>/delete/',groups.group_delete_view,name='group-delete'),
    ...
    path('student/<int:id>/change-status/', students.student_change_status, name='change-student-status'),
    ...
    path('leads/filter/',leads.leads_filter_view,name='lead-filter-list'),
    path('leads/archive/',leads.leads_archive_view,name='lead-archive-list'),
